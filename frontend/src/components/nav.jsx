...
import { faBars, faTimes, faHome, faTachometerAlt, faQuestionCircle, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className={`fixed top-0 left-0 h-screen w-56 bg-blue-950 md:flex flex-col items-center ${menuOpen ? "block" : "hidden"} md:block`}>
                    ...
                    <div className="h-128 flex flex-col items-center mt-5 justify-around">
                        <div className="flex gap-2 items-center mr-7">
                            ...
                            <Link to="/home" className="text-gray-300 font-semibold">Home</Link>
                        </div>
                        <div className="flex gap-2 items-center">
                            <FontAwesomeIcon icon={faTachometerAlt} className="text-gray-300" />
                            <Link to="/dashboard" className="text-gray-300 font-semibold">Dashboard</Link>
                        </div>
                        <div className="flex gap-2 items-center mr-11">
                            <FontAwesomeIcon icon={faQuestionCircle} className="text-gray-300" />
                            <Link to="/help" className="text-gray-300 font-semibold">Help</Link>
                        </div>
                        <div className="mr-6">
                            <button onClick={handleLogout} className="flex gap-2 items-center text-gray-300 font-semibold mt-auto mb-8">
